...
# Parameter parsing
# ================================================================================= 
parser = argparse.ArgumentParser(description="Write example")
arg_parsing.add_connection_parameters(parser)
arg_parsing.add_write_parameters(parser)
...
# =================================================================================
def write_example(client, uid, fid, field_name, value):
    msg = {
        "action": "W",
        "user_type": "root",
        "gmuid": "auto",
...
if __name__ == "__main__":
    ...
    write_example(client, uid, fid, field_name, value)
    client.loop_forever()
